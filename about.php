			...
			<main class="main-content">
				<div class="container">
					<div class="page">
						...
						<div class="row">
							<div class="col-md-4">
								<figure><img src="images/icon_film.jpg" alt="figure image"></figure>
							</div>
							<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="images/wahid.jpg" alt=""></figure>
									<h2 class="team-name">Wahid Rohman Nugroho</h2>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="images/niken.jpg" alt=""></figure>
									<h2 class="team-name">Niken Oktaviana</h2>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="images/farid.jpg" alt=""></figure>
									<h2 class="team-name">Farid Makarim</h2>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="images/clarita.jpg" alt=""></figure>
									<h2 class="team-name">Clarita Magdalena</h2>
				...
				<div class="container">
					...
					<div class="colophon">Copyright 2020 MV Review, Designed by Themezy. All rights reserved</div>
				</div> <!-- .container -->
